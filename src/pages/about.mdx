...
Parallax Labs is a non-profit research organisation building the second viewpoint. Our mission is to **make white-box auditing of agents' internal beliefs, goals, and plans a core layer of frontier AI evaluations**. By combining behavioural evidence with evidence drawn from a model's internals, evaluators gain the depth analysis that behaviour alone cannot provide.
...
We will measure success in concrete steps. In our first year, we aim to deliver a working integration between a leading interpretability framework and a widely-used evaluation harness, and to publish a re-audit of at least one frontier open-weight model demonstrating an explanatory finding that behavioural evidence alone could not produce. Beyond that, our mark of success is white-box auditing becoming a standard layer of frontier AI evaluation, with leading evaluators reaching for our tools as a default in their day-to-day workflows.

### Who are we doing this for

**We aim to make white-box auditing a shared public good for the frontier evaluation ecosystem.** Our methods and infrastructure will be open-source and fully accessible to government evaluation bodies, independent auditors, frontier model developers, and AI safety researchers, bringing together a cohesive evaluations and interpretability ecosystem, rather than proprietary systems locked inside a single organisation.

In terms of impact, our mark of success will be the widespread adoption of white-box alignment auditing as a standard layer of frontier AI evaluation, and leading evaluators and researchers trusting and regularly employing our tools and methods for their audits.
